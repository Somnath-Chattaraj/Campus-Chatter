        ...
        <div className="flex flex-col md:flex-row items-center h-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 w-full md:w-1/2 h-full">
            ...
            {[
              ...
              <div
                key={index}
                className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col justify-between h-full feature-card"
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-blue-500 font-bold text-xl cursor-pointer">
                    →
                  </span>
                </div>
              </div>
          ...
          <div className="md:pl-16 md:w-1/2 mt-10 md:mt-0 text-center md:text-left">
            <h2 className="text-3xl md:text-6xl font-bold text-gray-800 mb-4">
              Why <br />
              <span className="underline">Campus Chatter?</span>
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              Campus Chatter can provide users with a wide range of benefits,
              from staying connected with loved ones to discovering new
              connections and engaging in creative expression and community
              building.
            </p>
